...
class TestUsers:
    ...
    @pytest.mark.parametrize("user_id", [1, 6, 15])
    ...
    def test_create_user(self):
        ...
        assert response.status_code in [200, 201], f"Ожидался 200/201, получили {response.status_code}"
    ...
    def test_delete_user(self, user_id):
        ...
        # DELETE обычно возвращает 200, 204 (No Content) или 202
